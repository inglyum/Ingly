...
export function renderDashboard(d) {
  ...
  return `<div class="v2-grid">${kpis.map(([l, v]) =>
    ...
    <div class="v2-grid" style="margin-top:10px">
      ...
      <div class="v2-kpi"><div class="v2-kpi-l">Acquisti</div><div class="v2-kpi-v">${d.purchasesTotal || 0}</div></div>
      <div class="v2-kpi"><div class="v2-kpi-l">Valore acquisti</div><div class="v2-kpi-v">${eur(d.purchasesValue || 0)}</div></div>
